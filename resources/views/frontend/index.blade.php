            ...
            <div class="card-body">
                <table class="table table-bordered border-primary p-2">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th scope="row" style="color: rgb(253, 253, 253);">মঙ্গলবার</th>
...
{{-- Massage to guirdeans --}}
    ...
    <div class="container-xxl py-5">
        <div class="container">
                <h6 class="section-title bg-white text-center text-primary px-1 mb-5">পড় তোমার প্রভুর নামে যিনি সৃষ্টি করেছেন</h6>
            <div class="row g-4">
